...
protected:
  ...
  void GetEta_Effective(const typecode pp1, float tau_yield, float D_tensor_magn
    ,float visco, float m_NN, float n_NN, float reg_NN, float reg_strain, float &visco_etap1)const; // Robin: added reg_NN and reg_strain
  ...
  template<TpKernel tker, TpFtMode ftmode> void InteractionForcesBound_NN_FDA
    (unsigned n, unsigned pini, tint4 nc, int hdiv, unsigned cellinitial
    ,const unsigned *beginendcell, tint3 cellzero, const unsigned *dcell
    ,const tdouble3 *pos, const tfloat4 *velrhopp, const typecode *code, const unsigned *id
    ,float &viscdt, float *ar)const;
  ...
  //SPH
  template<TpKernel tker, TpFtMode ftmode, TpVisco tvisco, TpDensity tdensity, bool shift>
    void InteractionForcesFluid_NN_SPH_ConsEq
  ...
  template<TpKernel tker, TpFtMode ftmode, TpVisco tvisco, TpDensity tdensity, bool shift>
    void InteractionForcesFluid_NN_FDA_All
    (unsigned n, unsigned pini, tint4 nc, int hdiv, unsigned cellfluid, float visco, float *visco_eta
    ,const unsigned *beginendcell, tint3 cellzero, const unsigned *dcell
    ,const tsymatrix3f* tau, tsymatrix3f* gradvel
    ,const tdouble3 *pos, const tfloat4 *velrhop, const typecode *code, const unsigned *idp
    ,const float *press
